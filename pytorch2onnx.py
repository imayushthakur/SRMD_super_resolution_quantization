...
model_list = ['srmd_x2', 'srmd_x3', 'srmd_x4',
              'srmdnf_x2', 'srmdnf_x3', 'srmdnf_x4']
...
for model_name in model_list:
    ...
    torch_out = torch.onnx._export(model, x, os.path.join(
        output_model_pool, model_name+".onnx"), export_params=True)
